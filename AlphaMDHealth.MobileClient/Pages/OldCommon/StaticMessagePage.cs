...
public class StaticMessagePage : BasePage
{
    ...
    /// </summary>
    public StaticMessagePage() : base(PageLayoutType.EndToEndPageLayout, false)
    {
        LoadUI();
    }
    ...
    public StaticMessagePage(string key) : base(PageLayoutType.LoginFlowPageLayout, false)
    {
        _key = key;
        LoadUI();
    }
