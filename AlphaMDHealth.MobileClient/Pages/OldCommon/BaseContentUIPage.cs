...
public partial class BasePage
{
    ...
    public bool RunMyValidation(List<View> pageControls)
    {
    ...
    public bool RunValidation(List<View> pageControls)
    {
        ...
        //{
        //BaseContentView customControl = null;
        //switch (control.GetType().Name)
        //{
        //case nameof(CustomEntryControl):
        //    customControl = (CustomEntryControl)control;
        //    break;
        //case nameof(CustomMobileControl):
        //    customControl = (CustomMobileControl)control;
        //    break;
        //case nameof(CustomMultiLineEntryControl):
        //    customControl = (CustomMultiLineEntryControl)control;
        //    break;
        //case nameof(CustomDateTimeControl):
        //    customControl = (CustomDateTimeControl)control;
        //    break;
        //case nameof(CustomBindablePickerControl):
        //    customControl = (CustomBindablePickerControl)control;
        //    break;
        //case nameof(CustomDropDownMultiSelectControl):
        //    customControl = (CustomDropDownMultiSelectControl)control;
        //    break;
        //case nameof(CustomRadioList):
        //    customControl = (CustomRadioList)control;
        //    break;
        //case nameof(CustomCheckBoxListControl):
        //    customControl = (CustomCheckBoxListControl)control;
        //    break;
        //default:
        //    //will use for future implementation
        //    break;
        //}
        //isFormValid = AddValicationBasedOnEnabledControled(isFormValid, customControl);
        //});
        if (isFormValid)
        {
            isFormValid = RunMyValidation(pageControls);
        }
        return isFormValid;
    }

    private static bool AddValicationBasedOnEnabledControled(bool isFormValid, BaseContentView customControl)
    {
        if (customControl != null && customControl.IsEnabled)
        {
            customControl.ValidateControl(true);
