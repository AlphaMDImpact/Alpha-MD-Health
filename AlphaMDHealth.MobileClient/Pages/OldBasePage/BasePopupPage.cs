...
public class BasePopupPage : PopupPage, IDisposable
{
    ...
    public BasePopupPage(BasePage page)
	{
        ...
        Content = new PancakeView
        {
            ...
            CornerRadius = new OnIdiom<CornerRadius> { Phone = new CornerRadius(padding * 2, padding * 2, 0, 0),
    ...
    {
        _leftHeaderButton.Value = _parentPage.GetResourceValueByKey(resourceKey);
        _leftHeaderButton.OnValueChanged += OnLeftHeaderButtonClicked;
    }
    ...
    {
        _rightHeaderButton.Value = _parentPage.GetResourceValueByKey(resourceKey);
        _rightHeaderButton.OnValueChanged += OnRightHeaderButtonClicked;
    }
    ...
    protected void DisplayBottomButton(string resourceKey, FieldTypes controlType)
    {
        ...
        _bottomButton.Value = _parentPage.GetResourceValueByKey(resourceKey);
        _bottomButton.OnValueChanged += OnBottomButtonClicked;
    }
    ...
    private BoxView CreateLinkSeparator(bool isVisible)
    {
        return new BoxView
        {
