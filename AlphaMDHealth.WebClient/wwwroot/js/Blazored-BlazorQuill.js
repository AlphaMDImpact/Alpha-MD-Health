(function () {
    window.QuillFunctions = {        
        ...
        attachTextChangeEvent: function (quillElement, quillObject) {
            quillElement.__quill.on('text-change', function (delta, oldDelta, source) {
                quillObject.invokeMethodAsync("OnTextChanged", delta, oldDelta, source, quillElement.__quill.root.innerHTML);
            });
        }
    };
})();