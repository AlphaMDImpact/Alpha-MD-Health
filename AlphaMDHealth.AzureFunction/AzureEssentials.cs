...
{
    public class AzureEssentials : IEssentials
    {
        ...
        public AzureEssentials(StorageState storageState)
        {
        ...
        public Task<string> GetDeviceIDAsync()
        {
            ...
            {
                deviceID = Guid.NewGuid().ToString() + GenerateRandomNumber(100, 999).ToString(CultureInfo.CurrentCulture) + DateTimeOffset.UtcNow.ToUnixTimeMilliseconds();
        ...
        public bool SetPreferenceValue<T>(string key, T value)
        {
            ...
            if (_storageState.Preferences == null)
            {
